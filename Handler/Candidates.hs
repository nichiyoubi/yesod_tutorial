...
--		        titles <- runDB $ selectList [] [Asc CandidateDaysTitle]
			...
			case mday1 of Just day1 -> (runDB $ insert $ CandidateDays listId name day1)
			mday2 <- runInputPost $ iopt textField "day2"
			case mday2 of
			     Just day2 -> runDB $ insert $ CandidateDays listId name day2
...
--			case mday10 of Just day10 -> (runDB $ insert $ CandidateDays listId name day10)
